...
libphonenumber.util = {
  ...
  getCountryCode(regionCode) {
    const cc = libphonenumber.getCountryCodeForRegion(regionCode);
    return cc !== 0 ? cc : '';
  },

  parseNumber(number, defaultRegionCode) {
    try {
...
exports = module.exports = libphonenumber;
